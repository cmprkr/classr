...
export default function Sidebar({
  ...
  if (collapsed) {
    return (
      ...
      >
        ...
        {/* Bottom avatar (keep simple in collapsed) */}
        <div className="border-t pb-4 flex items-center justify-center">
          <a href="/account" className="hover:opacity-80" aria-label={displayName}>
  ...
  return (
    ...
    >
      {/* Brand row with collapse chevron */}
